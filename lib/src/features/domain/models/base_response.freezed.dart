...
abstract class _Success implements Success {
  factory _Success({final String message}) = _$SuccessImpl;
...
class _$FailureImpl implements _Failure {
  _$FailureImpl({this.message = '', this.errorCode = ''});
...
abstract class _Failure implements Failure {
  factory _Failure({final String message, final String errorCode}) =
      _$FailureImpl;
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  _$ApiResponseImpl({this.data, this.success, this.failure});
