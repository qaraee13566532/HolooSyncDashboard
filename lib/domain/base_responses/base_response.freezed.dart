...
abstract class $ApiResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T? data, Success? success, Failure? failure});
...
class _$ApiResponseImpl<T> implements _ApiResponse<T> {
  const _$ApiResponseImpl({this.data, this.success, this.failure});
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>(data: $data, success: $success, failure: $failure)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(data), success, failure);
...
abstract class _ApiResponse<T> implements ApiResponse<T> {
  const factory _ApiResponse(
      {final T? data,
      final Success? success,
      final Failure? failure}) = _$ApiResponseImpl<T>;
